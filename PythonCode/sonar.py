...
def makeMove(board, chests, x, y):
    ...
    # from the chests list as they are found. Reture False if this is an invalid move.
    # Otherwise, return the string of the result this move.
...
if to find the three sunken treasure chests that are lurking in the part of the
...
The treasure chests don't move around. Sonar device can detect treasure
...
while True:
    ...
    while sonarDevices > 0:
        ...
        if len(theChests) == 0:
            print('You have found all the sunken treasure chests! Congratulatiions and good game!')
            break
