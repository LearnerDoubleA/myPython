...
WINWIDTH = 640 # width of the programe's window, in pixels
...
Keys used by all the three data structures:
...
def runGame():
    ...
    # create the surface to hold game text
        ...
        if not gameOverMode:
            ...
            for i in range(len(squirrelObjs)-1, -1, -1):
                ...
                if 'rect' in sqObj and playerObj['rect'].colliderect(sqObj['rect']):
                    # a player/squirrel collision has occured
...
def getBounceAmount(currentBounce, bounceRate, bounceHeight):
    ...
    # Larger bounceHealth means a highter bounce.
