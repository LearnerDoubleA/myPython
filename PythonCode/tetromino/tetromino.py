...
def showTextScreen(text):
    # Thie function displays large text in the
...
def calculateLevelAndFallFreq(score):
    # Based on the screen, return the level the player is on and
    # how many seconds pass until a falling piece falls on space.
