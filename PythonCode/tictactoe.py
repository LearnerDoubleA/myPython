...
def inputPlayerLetter():
    ...
    #Retruns a list with the player's letter as the first item, and the commputer's letter as the second.
    letter = ''
...
def isBoardFull(board):
    # Return True if every space onn the board has been taken. Otherwise return False.
    for i in range(1, 10):
        if isSpaceFree(board, i):
            return False
    return True
