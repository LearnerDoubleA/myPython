...
def inceptin_v3_arg_scope(weight_decay=0.00004, stddev=0.1, batch_norm_var_collection='moving_vars'):
    batch_norm_parms = {
        'decay': 0.9997,
        'epsilon': 0.001,
    ...
    with slim.arg_scope([slim.conv2d, slim.fully_connected], weights_regularizer=slim.l2_regularizer(weight_decay)):
        with slim.arg_scope(
            ...
            normalizer_params=batch_norm_parms) as sc:
            return sc
...
with slim.arg_scope(inceptin_v3_arg_scope()):
